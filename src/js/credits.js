...
var CreditsScene = {
	...
	create: function () {
	    ...
	    // Créditos
	    this.text1 = this.game.add.bitmapText(this.game.world.centerX, creditsY * 3, 'videogame', 'Game Design & Development:', 25);
	    this.text1.anchor.setTo(0.5);
	    this.text2 = this.game.add.bitmapText(this.game.world.centerX, creditsY * 4, 'videogame', 'Nestor Cabrero, Martin Amechazurra', 25);
	    this.text2.anchor.setTo(0.5);
	    this.text3 = this.game.add.bitmapText(this.game.world.centerX, creditsY * 6, 'videogame', 'Music:', 25);
	    this.text3.anchor.setTo(0.5);
	    this.text4 = this.game.add.bitmapText(this.game.world.centerX, creditsY * 7, 'videogame', '"Blue Space" by FoxSynergy', 25);
	    this.text4.anchor.setTo(0.5);
	    this.text5 = this.game.add.bitmapText(this.game.world.centerX, creditsY * 8, 'videogame', '"Korobeiniki" by Dave Wave', 25);
